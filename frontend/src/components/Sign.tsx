...
const Sign = (props: SignProps) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const endpoint = props.signIn ? 'http://localhost:5000/api/users/users/login' : 'http://localhost:5000/api/users/users';
        ...
        try {
            ...
            if (response.ok) {
                ...
                alert(data.message || (props.signIn ? 'Login failed' : 'Error creating user'));
            }
        } catch (error) {
